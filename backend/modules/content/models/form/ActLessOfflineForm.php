...
namespace app\modules\content\models\form;
 ...
 */
class ActLessOfflineForm extends \common\models\ActLessons
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['less_cate', 'expert_id', 'created_at','status','less_mode'], 'integer'],
            [['content'], 'string'],
